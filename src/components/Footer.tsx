        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-serif font-semibold">Silver Elegance</span>
            </div>
            <p className="text-gray-400 mb-4 max-w-md">
              Discover our exquisite collection of silver plated items, crafted with precision and elegance for the discerning customer.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/products" className="text-gray-400 hover:text-brand-primary transition-colors">Products</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li>123 Silver Street</li>
              <li>Elegance City, EC 12345</li>
              <li>Phone: (555) 123-4567</li>
              <li>Email: info@silverelegance.com</li>
            </ul>
          </div>
        </div>
